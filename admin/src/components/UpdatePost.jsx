...
//   // const getPostData = async ({sl}) => {
//   //   // const {title, content, meta, thumbnail, tags, slug } = post;
...
//   return (
//     <form className='px-5 bg-black rounded-full py-12'>
//         <ul className='my-12'>
//           <li>
//             <input type='text' name='title' placeholder='제목' className='border border-gray-800 rounded-md w-full my-1 p-1' />
//           </li>
//           <li>
//             <textarea rows='20' name='content' className='border border-gray-800 rounded-md w-full my-1 p-1'></textarea>
//           </li>
//           <li>
//             <input type='file' name='thumbnail' className='border border-gray-800 rounded-md w-full my-1 p-1 bg-white' />
//           </li>
//           <li>
//             <input type='text' name='meta' placeholder='meta' className='border border-gray-800 rounded-md w-full my-1 p-1' />
//           </li>
//           <li>
//             <input type='text' name='tags' placeholder='태그' className='border border-gray-800 rounded-md w-full my-1 p-1' />
//           </li>
//         </ul>
        
//         <div className='flex flex-row justify-center items-center my-5'>
//           <button className='border-2 rounded-full inline-block py-3 px-10 mx-2 text-white hover:bg-white hover:text-black'>등록</button>
//           <button className='border-2 rounded-full inline-block py-3 px-10 mx-2 text-white hover:bg-white hover:text-black'>취소</button>
//         </div>
//     </form>
//   )
// }
